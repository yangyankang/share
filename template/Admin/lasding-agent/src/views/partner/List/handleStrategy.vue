...
import { createTPCustomStrategy, updateTPCustomStrategy } from '@/api/price'
  ...
  data () {
    return {
      ...
      formRules: {
        ...
        subcategoryId: [
          {required: true, message: '请选择产品子分类', trigger: 'change'}
        ]
        // fixLevel: [
