<template>
  ...
  >
    <div v-loading="dataLoading" style="max-height: 450px; overflow: auto;">
      <el-tree
        :data="dataTree"
        :props="{label: 'regionName', disabled: isDisabledCheckbox}"
...
import { GetGroupRegionTree, GetStrategyRegions } from '@/api/price'
export default {
  mixins: [dialogMinix],
  props: {
    row: {
